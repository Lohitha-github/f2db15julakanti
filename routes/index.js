...
router.get('/', function (req, res) {
  res.render('index', { title: 'eatable App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'eatable App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'eatable App Login', user: req.user });
});
